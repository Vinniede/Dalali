...
export const SuperAdminDashboard: React.FC = () => {
  ...
  const [recentActivity, setRecentActivity] = React.useState([
    {
      id: 1,
      message: "Shipment XF27 updated to In Transit",
      timestamp: "5 mins ago",
    },
    {
      id: 2,
      message: "New branch admin added for Entebbe",
    ...
    {
      id: 4,
      message: "Fleet utilization: 87%",
      timestamp: "Today at 10:30 AM",
    },
    {
      id: 5,
      message: "Average delivery time: 2.3 days",
      ...
      <div className="space-y-6 sm:space-y-8">
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            <button className="px-3 sm:px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition text-sm sm:text-base">
              + Create Shipment
            </button>
            ...
            <button className="px-3 sm:px-6 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium transition text-sm sm:text-base">
              + Add Branch Admin
            </button>
            <button className="px-3 sm:px-6 py-2 border-2 border-gray-300 hover:bg-gray-50 text-gray-700 rounded-lg font-medium transition text-sm sm:text-base">
              📊 View Reports
            </button>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-lg shadow p-4 sm:p-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              {recentActivity.map((activity) => (
                <div
                  key={activity.id}
                  className="flex items-start gap-3 pb-3 sm:pb-4 border-b last:border-b-0"
                >
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg shadow text-white p-6 sm:p-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8 text-center">
            ...
            <div>
              <p className="text-2xl sm:text-3xl font-bold">2.3d</p>
              <p className="text-blue-100 text-xs sm:text-sm">
                Avg Delivery Time
              </p>
            </div>
