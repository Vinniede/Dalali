          ...
          <div className="card-elevated bg-gradient-to-br from-blue-50 to-indigo-50">
            ...
            <form onSubmit={handleCreateBranch} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <label className="block text-xs font-bold text-gray-700 mb-2 uppercase tracking-wide">Branch Name</label>
                  <input
                    type="text"
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="card-elevated bg-gradient-to-br from-blue-50 to-blue-100">
                <p className="text-gray-600 text-sm font-semibold">Total Branches</p>
              ...
              <div className="card-elevated bg-gradient-to-br from-purple-50 to-purple-100">
                ...
                <p className="text-3xl font-bold text-purple-600 mt-1">{new Set(branches.map(b => b.country)).size}</p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {branches && branches.length > 0 ? (
                branches.map((branch) => (
                  <div key={branch.id} className="card-elevated border-l-4 border-primary-600 hover:shadow-lg transition">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h3 className="text-lg font-bold text-gray-900">🏢 {branch.name}</h3>
                        <p className="text-sm text-gray-600 mt-1">📍 {branch.country}</p>
                      </div>
                    ...
                    <div className="space-y-2 mb-4 pb-4 border-b border-gray-200">
                      <div className="flex items-center gap-2">
                        ...
                        <p className="text-gray-900 font-mono">{branch.phone}</p>
                      </div>
                    </div>
