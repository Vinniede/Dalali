    ...
    <Router>
      <Routes>
        ...
        <Route
          ...
          element={
            <ProtectedRoute
              element={<BranchAdminShipments />}
              requiredRoles={["branch_admin"]}
            />
          }
        />
        <Route
          path="/admin/branch/shipments/:id"
          element={
            <ProtectedRoute
        ...
        <Route
          ...
          element={
            <ProtectedRoute
              element={<BranchAdminCreateShipment />}
              requiredRoles={["branch_admin"]}
            />
          }
        />
